...
/* Judge entry source: true only when selected from the Auditor/selection screen. */
...
function teamRegistration() {
  ...
  return `
    <div class="card">
      ...
      <p class="muted">
        Each team must contain five members.
      </p>
    ...
    <div class="card">
      ...
      >
        ...
        <input
          ...
          placeholder="Enter second performer's name"
          maxlength="100"
        >

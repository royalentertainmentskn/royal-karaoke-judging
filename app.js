...
function printResults() {
  ...
  printWindow.document.write(`
    ...
    <html>
    <head>
      <title>${E(competitionName)} — Results</title>
      ...
      <div class="winners">
        ...
        <div class="winner">
          ...
          <div class="score">
            ${
              overallWinner
                ? overallWinner.avg.toFixed(2) + "/100"
                : "—"
            }
          </div>
        </div>
        ...
        <div class="winner">
          <h3>BEST FEMALE</h3>
          <div class="name">
            ${winnerName(bestFemale)}
          </div>
          <div class="score">
            ${
              bestFemale
                ? bestFemale.avg.toFixed(2) + "/100"
                : "—"
            }
          </div>
        </div>
              ...
              ? sortedRows
                  .map((x, index) => `
                    <tr>
                      ...
                      <td class="center">
                        ${x.submitted}/${judgeTotal}
                      </td>

                      <td class="center">
                        ${
                          x.complete
                            ? `<strong>${x.avg.toFixed(2)}/100</strong>`
                          ...
                          <td>
                            ${
                              sortedRows.filter(
                                x =>
                                  x.complete &&
                                  getContestantTeam(x) === team
                              ).length
                            }
                          </td>
                          <td>
                            <strong>
                              ${Number(total).toFixed(2)} / 600
                            </strong>
                          </td>
                        </tr>
                      `
